...
export default function NotFound() {
  return (
    <div className="min-h-screen bg-gradient-to-br from-orange-500 to-orange-600 flex flex-col items-center justify-center p-4">
      <div className="relative bg-[#FFFCF8]/10 backdrop-blur-lg rounded-2xl p-8 shadow-2xl text-center space-y-8 max-w-2xl mx-auto">
        ...
        >
          <XCircle className="w-24 h-24 mx-auto text-white/90 drop-shadow-lg" />
        </motion.div>
        ...
        {/* Logo with animation */}
        <motion.div 
          className="text-2xl font-bold text-white flex justify-center py-12"
        ...
        >
          <Link href="/">
            <Button 
              size="lg"
              className="min-w-[200px] bg-[#FFFCF8]/20 hover:bg-[#FFFCF8]/30 backdrop-blur-sm transition-all duration-300 flex items-center gap-2 text-white border border-white/20"
            >
