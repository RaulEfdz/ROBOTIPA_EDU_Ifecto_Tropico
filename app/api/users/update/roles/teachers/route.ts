...
// Obtener el TEACHER_ID desde las variables de entorno
...
if (!TEACHER_ID) {
  console.error(
    "FATAL ERROR: TEACHER_ID not defined in environment variables."
  );
...
export async function POST(req: NextRequest) {
  try {
    ...
    // Verificar si el ID del usuario a actualizar coincide con el TEACHER_ID
    if (TEACHER_ID && id === TEACHER_ID) {
