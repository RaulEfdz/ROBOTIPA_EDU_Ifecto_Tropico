// File: components/tabs/ExamDetailsForm.tsx
"use client";
...
export default function ExamDetailsForm({
  ...
  const cancelPublish = () => {
    setPendingState(publishedState);
    setIsConfirmOpen(false);
  };
              ...
              >
                ...
                <SelectContent>
                  <SelectItem value="draft">
                    <div className="flex items-center gap-2">
                      <FileText className="w-4 h-4 text-yellow-600" /> Borrador
                    </div>
                  </SelectItem>
                  <SelectItem value="published">
                    <div className="flex items-center gap-2">
                      <Globe className="w-4 h-4 text-green-600" /> Publicado
                    </div>
                  </SelectItem>
                </SelectContent>
              </Select>
